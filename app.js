...
function cond(){var m=D.racing.meetings[mi];if(!m)return;$("#cT").textContent=m.track;$("#cC").textContent=m.condition;$("#cR").textContent=m.rail;$("#cB").textContent=(m.biasZone||"\u2014")+" / "+(m.biasStrength||0);
...
b.innerHTML=any?out:'<p style="color:#6E9C8C">No roughies flagged across today\u2019s meetings.</p>';strike();return}
